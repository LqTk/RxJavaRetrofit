package com.example.weathernet.network.utils;
...
//        String telRegex = "[1][34578]\\d{9}";//"[1]"代表第1位为数字1，"[358]"代表第二位可以为3、5、8中的一个，"\\d{9}"代表后面是可以是0～9的数字，有9位。
     ...
     * @return
     */
    public static String get2F(float num){
        return String.format("%1.2f",num);
    }
    /**
     * 后台返回的金额以分为单位，用此方法保留小数后两位
     * @param num
     * @return
     */
    public static String get2F(int num){
        return String.format("%1.2f",num / 100.00f);
    }
}
